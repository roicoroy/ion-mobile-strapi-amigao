...
export class StrapiService {
    ...
    public userState: Subject<void> = new Subject();
    ...
    public refreshUserState(user?) {
        if (user) {
            ...
            // this.iosStorage.storageSet('user', myUser).then(() => {
            //   this.store.dispatch(new AuthActions.SetUser(myUser));
            // });
        }
    }
    public isLoggedIn() {
